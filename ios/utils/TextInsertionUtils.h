...
+ (void)insertTextInAttributedString:(NSString*)text at:(NSInteger)index additionalAttributes:(NSDictionary<NSAttributedStringKey, id>*)additionalAttrs attributedString:(NSMutableAttributedString *)attributedString;
@end
