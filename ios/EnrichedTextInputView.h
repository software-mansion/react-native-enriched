...
@property (nonatomic, strong) NSDictionary<NSNumber *, NSArray<NSNumber *> *> *conflictingStyles;
@property (nonatomic, strong) NSDictionary<NSNumber *, NSArray<NSNumber *> *> *blockingStyles;
