...
- `alignment` indicates the paragraph alignment of the current selection (one of `left`, `center`, or `right`).
...
Sets the alignment of the paragraph(s) in the current selection.

- `alignment` - the alignment to apply (`left`, `center`, or `right`).
