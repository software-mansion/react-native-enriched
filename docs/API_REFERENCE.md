...
The `style` prop controls the layout, dimensions, typography, borders, shadows, opacity, and similar container-level appearance
of the editable content container. See `[EnrichedInputStyle](#enrichedinputstyle)` for the supported properties.

| Type                                        | Default Value | Platform |
| ------------------------------------------- | ------------- | -------- |
| `[EnrichedInputStyle](#enrichedinputstyle)` | -             | Both     |
